...
<script type="text/javascript">
    ...
    function pageSelectCallback(pageIndex, jQuery){
        ...
        // 执行页面跳转
        window.location.href = "admin/search/ssm.html?pageNum="+pageNum+"&keyCard=${param.keyCard}";
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline" action="admin/search/ssm.html" method="post" role="form" style="float:left;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                <div class="input-group-addon">查询条件</div>
                                <input class="form-control has-success" name="keyCard" type="text" placeholder="请输入查询条件" value="${param.keyCard}"/>
                            </div>
                        </div>
                            ...
                            <c:if test="${!empty requestScope.pageInfo.list}">
                                <c:forEach items="${requestScope.pageInfo.list}" var="admin" varStatus="status">
                                    <tr>
                                        ...
                                        <td>${admin.email}</td>
                                        <td>
                                            <a href="assign/getAdminRole/ssm.html?adminId=${admin.id}&pageNum=${requestScope.pageInfo.pageNum}&keyword=${param.keyword}" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></a>
